 ...
 */
export default function WaveformEditorNoRegions({ audioUrl, onReady }) {
    ...
    return () => {
      if (waveRef.current) {
        try {
          ...
          if (destroyErr.name !== "AbortError") {
            console.error("WaveSurfer destroy error:", destroyErr);
          }
        }
...
WaveformEditorNoRegions.propTypes = {
  audioUrl: PropTypes.string.isRequired,
  onReady: PropTypes.func,
};

WaveformEditorNoRegions.defaultProps = {
  onReady: null,
};